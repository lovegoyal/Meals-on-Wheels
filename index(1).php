			...
			<nav class="navbar navbar-inverse navbar-static-top">
				<div class="container">
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="index.html" ><h1>Meals On Wheels</h1></a>
					</div>
					<fieldset>
					...
					<div id="navbar" class="navbar-collapse collapse">
						<ul class="nav navbar-nav navbar-right cl-effect-21">
							...
							<li><a href="#test" class="page-scroll">Testimonials</a></li>
							<li><a href="#contact" class="page-scroll">Contact</a></li>
							<li><a href="./signup.php" class="page-scroll">Sign Up</a></li>
							<li>
							<form>
							<div id="admin">ADMIN PANEL</font><select name="admin" onchange="location=this.value;">
...
<section class="services-w3l" id="services">
	<div class="container">
		...
		<div class="col-lg-4 col-md-4 col-sm-4 w3-agile">
			...
			<p data-aos="flip-up">A drive-in is a facility where one can drive in with an automobile for service
			It is usually served by staff who walk or rollerskate out to take orders and return with food</p>
		</div>
		<div class="col-lg-4 col-md-4 col-sm-4 w3-agile">
			<div class="hi-icon-wrap hi-icon-effect-5 hi-icon-effect-5d" data-aos="flip-up">
		...
		<div class="col-lg-4 col-md-4 col-sm-4 w3-agile">
			...
			<p data-aos="flip-up">We will deliver from any restaurant listed on the search results for your location.
			We recommend enabling your GPS location finder and letting the app auto-detect your location.
</p>
		</div>
		<div class="col-lg-4 col-md-4 col-sm-4 w3-agile">
			<div class="hi-icon-wrap hi-icon-effect-5 hi-icon-effect-5d" data-aos="flip-up">
			...
			<p data-aos="flip-up">You can pay from the Paytm or Paypal Applications and cash on delivery is also available</p>
		</div>
		<div class="col-lg-4 col-md-4 col-sm-4 w3-agile">
			<div class="hi-icon-wrap hi-icon-effect-5 hi-icon-effect-5d" data-aos="flip-up">
	...
	<div class="container">
		...
		<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 team-agile" data-aos="zoom-in">
			<div class="view view-third">
                <img src="images/love.jpg" alt="w3layouts" class="img-responsive"/>
                <div class="mask">
                    <h4>Love Goyal</h4>
		...
		<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 team-agile" data-aos="zoom-in">
			<div class="view view-third">
                <img src="images/ramyata.jpg" alt="w3layouts" class="img-responsive"/>
                <div class="mask">
		...
		<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 team-agile" data-aos="zoom-in">
			<div class="view view-third">
                <img src="images/harkirat.jpg" alt="w3layouts" class="img-responsive"/>
                <div class="mask">
                    <h4>Harkirat Singh Malhotra</h4>
                    <ul class="social-icons1">
						<li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
						<li><a href="#"><i class="fa fa-google" aria-hidden="true"></i></a></li>
						<li><a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
	...
	<div class="container">
		...
		<div class="col-lg-3 col-md-3 col-sm-6 footer-w3-agile3" data-aos="flip-left">
			...
			<ul class="contact-info">
				<li><p><i class="fa fa-phone" aria-hidden="true"></i> +919518188386</p></li>
				<li><p><i class="fa fa-phone" aria-hidden="true"></i> +918816869000</p></li>
				<li><p><a href="mailto:goyallove232@gmail.com"><i class="fa fa-envelope-o" aria-hidden="true"></i> goyallove232@gmail.com</a></p></li>
				<li><p><a href="mailto:harkiratmalhotra@gmail.com"><i class="fa fa-envelope-o" aria-hidden="true"></i> harkiratmalhotra@gmail.com</a></p></li>
			</ul>
		</div>
